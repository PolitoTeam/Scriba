...
// kelly's colors -
// https://i.kinja-img.com/gawker-media/image/upload/1015680494325093012.JPG hex
// values -
...
public:
  Colors() {
    ...
    list_colors = QList<QColor>({
        QColor(230, 143, 172), QColor(0, 103, 165),  QColor(249, 147, 121),
        QColor(96, 78, 151),   QColor(246, 166, 0),  QColor(179, 68, 108),
        QColor(220, 211, 0),   QColor(136, 45, 23),  QColor(141, 182, 0),
        QColor(101, 69, 34),   QColor(226, 88, 34),  QColor(43, 61, 38),
        QColor(243, 195, 0),   QColor(135, 86, 146), QColor(243, 132, 0),
        QColor(161, 202, 241), QColor(190, 0, 50),   QColor(194, 178, 128),
        QColor(132, 132, 130),
    });
  }
